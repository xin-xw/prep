...
4. The invariant here is before the start of each loop, the answer has not been found. If the answer has been found, the loop would end and we would return the result. We need to add the element inside the dictionary at each iteration to support our invariant.
